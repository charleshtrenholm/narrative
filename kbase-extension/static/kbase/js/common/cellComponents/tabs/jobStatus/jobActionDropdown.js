define(['jquery', 'bluebird', 'common/html', 'common/jobMessages', 'util/developerMode'], (
    $,
    Promise,
    html,
    JobMessages,
    ...
    function factory(config) {
        ...
        function doBatchJobAction(e) {
            ...
            // list of statuses that it is valid to perform the action on
            const validStatuses = {
            ...
            const jobIdList = jobManager.getJobIDsByStatus(statusList, validStatuses[action]);
